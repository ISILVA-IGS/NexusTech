...
class ControllerAlerta{
    ...
    enviarSms(valor,tipo){
        var time = new Date()
        var hour = date.getHour( date.getTime(time + 'GMT-9:00'))
        console.log(hour);
        var msg ="";
        var apelido ='';
        ...
        switch(tipo){
            case"tg":
                msg=`NexusTech: ${apelido} esta dentro dos Padroes recomendados, valor registrado as ${hour} e de ${valor} Graus Celsius`
            break;
            case"ty":
                msg=`NexusTech: ${apelido} em Situacao de Atencao, Temperatura fora dos Padroes recomendados valor registrado as ${hour} e de ${valor} Graus Celsius`
            break;
            case"tr":
                msg=`NexusTech: ${apelido} em Situacao de Emergencia,valor registrado as ${hour} e de ${valor} Graus Celsius`
            break;

            case"ug":
                msg=`NexusTech: ${apelido} dentro dos Padroes recomendados, valor registrado as ${hour} e de ${valor}% de Umidade`
            break;
            case"uy":
                msg=`NexusTech: ${apelido} em Situacao de Atencao,valor registrado as ${hour} e de ${valor}% de Umidade`
            break;
            case"ur":
                msg=`NexusTech: ${apelido} em Situacao de Emergencia,valor registrado as ${hour} e de ${valor}% de Umidade`
            break;
